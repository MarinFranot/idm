...
public interface SimplepdlPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Ressources Utilisees</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int WORK_DEFINITION__RESSOURCES_UTILISEES = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	...
	/**
	 * The meta object id for the '{@link simplepdl.impl.RessourceUtilisationImpl <em>Ressource Utilisation</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see simplepdl.impl.RessourceUtilisationImpl
	 * @see simplepdl.impl.SimplepdlPackageImpl#getRessourceUtilisation()
	 * @generated
	 */
	int RESSOURCE_UTILISATION = 6;
	 ...
	 * @ordered
	 */
	int RESSOURCE_UTILISATION__NOMBRE = 0;
	 ...
	 * @ordered
	 */
	int RESSOURCE_UTILISATION__RESSOURCE = 1;

	/**
	 * The number of structural features of the '<em>Ressource Utilisation</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESSOURCE_UTILISATION_FEATURE_COUNT = 2;

	/**
	 * The number of operations of the '<em>Ressource Utilisation</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESSOURCE_UTILISATION_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link simplepdl.WorkDefinition#getRessourcesUtilisees <em>Ressources Utilisees</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Ressources Utilisees</em>'.
	 * @see simplepdl.WorkDefinition#getRessourcesUtilisees()
	 * @see #getWorkDefinition()
	 * @generated
	 */
	EReference getWorkDefinition_RessourcesUtilisees();
	...
	/**
	 * Returns the meta object for class '{@link simplepdl.RessourceUtilisation <em>Ressource Utilisation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Ressource Utilisation</em>'.
	 * @see simplepdl.RessourceUtilisation
	 * @generated
	 */
	EClass getRessourceUtilisation();

	/**
	 * Returns the meta object for the attribute list '{@link simplepdl.RessourceUtilisation#getNombre <em>Nombre</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute list '<em>Nombre</em>'.
	 * @see simplepdl.RessourceUtilisation#getNombre()
	 * @see #getRessourceUtilisation()
	 * @generated
	 */
	EAttribute getRessourceUtilisation_Nombre();

	/**
	 * Returns the meta object for the reference '{@link simplepdl.RessourceUtilisation#getRessource <em>Ressource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Ressource</em>'.
	 * @see simplepdl.RessourceUtilisation#getRessource()
	 * @see #getRessourceUtilisation()
	 * @generated
	 */
	EReference getRessourceUtilisation_Ressource();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Ressources Utilisees</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference WORK_DEFINITION__RESSOURCES_UTILISEES = eINSTANCE.getWorkDefinition_RessourcesUtilisees();
		...
		/**
		 * The meta object literal for the '{@link simplepdl.impl.RessourceUtilisationImpl <em>Ressource Utilisation</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see simplepdl.impl.RessourceUtilisationImpl
		 * @see simplepdl.impl.SimplepdlPackageImpl#getRessourceUtilisation()
		 * @generated
		 */
		EClass RESSOURCE_UTILISATION = eINSTANCE.getRessourceUtilisation();
		 ...
		 * @generated
		 */
		EAttribute RESSOURCE_UTILISATION__NOMBRE = eINSTANCE.getRessourceUtilisation_Nombre();
		 ...
		 * @generated
		 */
		EReference RESSOURCE_UTILISATION__RESSOURCE = eINSTANCE.getRessourceUtilisation_Ressource();
