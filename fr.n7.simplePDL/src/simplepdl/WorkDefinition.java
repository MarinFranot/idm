 ...
 *   <li>{@link simplepdl.WorkDefinition#getRessourcesUtilisees <em>Ressources Utilisees</em>}</li>
 * </ul>
 *
...
public interface WorkDefinition extends ProcessElement {
	...
	/**
	 * Returns the value of the '<em><b>Ressources Utilisees</b></em>' containment reference list.
	 * The list contents are of type {@link simplepdl.RessourceUtilisation}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Ressources Utilisees</em>' containment reference list.
	 * @see simplepdl.SimplepdlPackage#getWorkDefinition_RessourcesUtilisees()
	 * @model containment="true"
	 * @generated
	 */
	EList<RessourceUtilisation> getRessourcesUtilisees();
