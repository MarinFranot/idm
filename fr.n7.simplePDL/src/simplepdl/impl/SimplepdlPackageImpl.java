...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 * @generated
	 */
	private EClass ressourceUtilisationEClass = null;
	 ...
	 * @generated
	 */
	public EReference getWorkDefinition_RessourcesUtilisees() {
	 ...
	 * @generated
	 */
	public EClass getRessourceUtilisation() {
		return ressourceUtilisationEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getRessourceUtilisation_Nombre() {
		return (EAttribute)ressourceUtilisationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getRessourceUtilisation_Ressource() {
		return (EReference)ressourceUtilisationEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(workDefinitionEClass, WORK_DEFINITION__RESSOURCES_UTILISEES);
		...
		ressourceUtilisationEClass = createEClass(RESSOURCE_UTILISATION);
		createEAttribute(ressourceUtilisationEClass, RESSOURCE_UTILISATION__NOMBRE);
		createEReference(ressourceUtilisationEClass, RESSOURCE_UTILISATION__RESSOURCE);
	...
	public void initializePackageContents() {
		...
		initEReference(getWorkDefinition_RessourcesUtilisees(), this.getRessourceUtilisation(), null, "ressourcesUtilisees", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(ressourceUtilisationEClass, RessourceUtilisation.class, "RessourceUtilisation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRessourceUtilisation_Nombre(), ecorePackage.getEInt(), "nombre", null, 0, -1, RessourceUtilisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRessourceUtilisation_Ressource(), this.getRessource(), null, "ressource", null, 1, 1, RessourceUtilisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
