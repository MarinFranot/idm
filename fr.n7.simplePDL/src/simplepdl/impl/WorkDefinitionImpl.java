 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getRessourcesUtilisees <em>Ressources Utilisees</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	/**
	 * The cached value of the '{@link #getRessourcesUtilisees() <em>Ressources Utilisees</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRessourcesUtilisees()
	 * @generated
	 * @ordered
	 */
	protected EList<RessourceUtilisation> ressourcesUtilisees;
	 ...
	 * @generated
	 */
	public EList<RessourceUtilisation> getRessourcesUtilisees() {
		if (ressourcesUtilisees == null) {
			ressourcesUtilisees = new EObjectContainmentEList<RessourceUtilisation>(RessourceUtilisation.class, this, SimplepdlPackage.WORK_DEFINITION__RESSOURCES_UTILISEES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__RESSOURCES_UTILISEES:
				return ((InternalEList<?>)getRessourcesUtilisees()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__NAME:
				...
				return;
			case SimplepdlPackage.WORK_DEFINITION__RESSOURCES_UTILISEES:
				getRessourcesUtilisees().clear();
				getRessourcesUtilisees().addAll((Collection<? extends RessourceUtilisation>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__RESSOURCES_UTILISEES:
				return ressourcesUtilisees != null && !ressourcesUtilisees.isEmpty();
		}
