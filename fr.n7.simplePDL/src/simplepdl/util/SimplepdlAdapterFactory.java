...
public class SimplepdlAdapterFactory extends AdapterFactoryImpl {
	...
	protected SimplepdlSwitch<Adapter> modelSwitch =
		new SimplepdlSwitch<Adapter>() {
			...
			@Override
			public Adapter caseRessourceUtilisation(RessourceUtilisation object) {
				return createRessourceUtilisationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link simplepdl.RessourceUtilisation <em>Ressource Utilisation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRessourceUtilisationAdapter() {
		return null;
	}
